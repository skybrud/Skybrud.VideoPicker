...
namespace Skybrud.VideoPicker.Models {
    ...
    public class VideoPickerImage  {
        ...
        protected VideoPickerImage(IPublishedContent content) {
            Image = content;
        ...
        /// <summary>
        /// Parses the specified <paramref name="content"/> into an instance of <see cref="VideoPickerImage"/>.
        /// </summary>
        /// <param name="content">The instance of <see cref="VideoPickerImage"/> to be parsed.</param>
        /// <returns>An instance of <see cref="VideoPickerImage"/>, or <code>null</code> if
        /// <paramref name="content"/> is <code>null</code>.</returns>
        public static VideoPickerImage GetFromContent(IPublishedContent content) {
            return content == null ? null : new VideoPickerImage(content);
        }
        ...
        /// <returns>An instance of <see cref="VideoPickerImage"/>, or <code>null</code> if the image could not be found.</returns>
        public static VideoPickerImage GetFromId(int imageId) {
